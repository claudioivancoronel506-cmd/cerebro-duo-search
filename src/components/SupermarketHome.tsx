...
import { catalogoProductos } from "@/lib/catalogo-supermercado";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="px-4 pt-5 pb-24">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-bold text-foreground">⚡ Productos destacados</h2>
          <button className="text-[11px] font-semibold flex items-center gap-0.5" style={{ color: "hsl(var(--store-secondary))" }}>
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {catalogoProductos.map((prod) => (
            <div key={prod.id} className="rounded-xl border border-border bg-card p-3 space-y-2">
